...
export default function ProductCard({
  ...
  return (
    <div className="not-prose glass-card glass-card-hover my-6 flex flex-col gap-4 rounded-2xl p-4 sm:flex-row">
      <div className="relative h-48 w-full shrink-0 overflow-hidden rounded-xl bg-white/5 sm:h-32 sm:w-32">
      ...
      <div className="flex flex-1 flex-col justify-between gap-3">
        ...
        <a
          ...
          className="gradient-button inline-block w-fit rounded-lg px-4 py-2 text-sm font-semibold text-white"
        >
          Buy Now
        </a>
      </div>
